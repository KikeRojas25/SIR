...
@Component({
  selector: 'app-baseingenico',
  templateUrl: './baseingenico.component.html',
  styleUrls: ['./baseingenico.component.css'],
  standalone: true,
    imports:[
      FormsModule,
      CommonModule,
...
export class BaseingenicoComponent implements OnInit {
   ...
   buscar() {
    ...
    const finalUrl = `http://104.36.166.65/RepSW/rep_baseingenico.aspx?fecinicio=${fecinicio}&fecfin=${fecfin}&idestado=${idestado}&idalmacen=${idalmacen}`;
