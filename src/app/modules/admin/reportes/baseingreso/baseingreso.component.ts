...
@Component({
  selector: 'app-baseingreso',
  templateUrl: './baseingreso.component.html',
  styleUrls: ['./baseingreso.component.css'],
   standalone: true,
      imports:[
        FormsModule,
        CommonModule,
...
export class BaseingresoComponent implements OnInit {
   ...
   buscar() {
    ...
    const finalUrl = `http://104.36.166.65/RepSW/rep_baseingreso.aspx?fecinicio=${fecinicio}&fecfin=${fecfin}&idestado=${idestado}`;
