...
@Component({
  selector: 'app-filtradoequipo',
  templateUrl: './filtradoequipo.component.html',
  styleUrls: ['./filtradoequipo.component.css'],
  standalone: true,
  imports:[
    FormsModule,
    CommonModule,
...
export class FiltradoequipoComponent implements OnInit {
